...
function setGoeySpring(spring2) {
  _spring = spring2;
}
...
var GoeyToast = ({
  ...
  const flush = (0, import_react49.useCallback)(() => {
    ...
    const rightSide = (pos == null ? void 0 : pos.includes("right")) ?? false;
  ...
  }, [showBody, actionSuccess, dismissing, prefersReducedMotion2, hovered]);
  ...
  const iconTransition = prefersReducedMotion2 ? { duration: 0.01 } : { duration: 0.2 };
  ...
  return (0, import_jsx_runtime12.jsxs)("div", { ref: wrapperRef, className: `${styles.wrapper}${(classNames == null ? void 0 : classNames.wrapper) ? ` ${classNames.wrapper}` : ""}`, style: isCenter ? { margin: "0 auto" } : isRight ? { marginLeft: "auto", transform: "scaleX(-1)" } : void 0, role: effectivePhase === "error" ? "alert" : "status", "aria-live": effectivePhase === "error" ? "assertive" : "polite", "aria-atomic": "true", onMouseEnter: () => {
    ...
    (0, import_jsx_runtime12.jsxs)(
      "div",
      {
        ...
        children: [
          (0, import_jsx_runtime12.jsx)("div", { ref: headerRef, className: `${styles.header} ${titleColorMap[effectivePhase]}${(classNames == null ? void 0 : classNames.header) ? ` ${classNames.header}` : ""}`, children: iconAndTitle }),
...
var goeyToast = Object.assign(
  (title, options) => createGoeyToast(title, "default", options),
  {
    ...
    promise: (promise, data) => {
      ...
      return toast.custom(() => (0, import_jsx_runtime12.jsx)(PromiseToastWrapper, { promise, data, toastId: id3 }), {
        id: id3,
        duration: ((_a = data.timing) == null ? void 0 : _a.displayDuration) != null || data.description ? Infinity : void 0
      });
    },
